...
public class ServerFragment extends Fragment {
    ...
    String UserNickName = "Server"; //idk what this should be.  doc's don't say.
    TextView logger;
                    ...
                    new PayloadCallback() {
                        ...
                        public void onPayloadReceived(String endpointId, Payload payload) {
                            ...
                            if (payload.getType() == Payload.Type.BYTES) {
                                ...
                                if (stuff.startsWith("Agree")&& startGame==0) {
                                    //send("Good to meet you Discovery");
                                    mdraw = new draw(this,player,endpointId);

                                    fragmentManager = getActivity().getSupportFragmentManager();
                                    fragmentManager.beginTransaction().replace(R.id.container, mdraw).commit();
            ...
            public void onConnectionResult(String endpointId, ConnectionResolution result) {
                ...
                switch (result.getStatus().getStatusCode()) {
                    case ConnectionsStatusCodes.STATUS_OK:
                        ...
                        logthis("Status ok, choosing X or O");
                        logthis("Sever chose X");
                        send("Player X");
                        player = 1;
                        break;
